...
ROLE_FA = (
    ...
    "تصادف، مدل/سال، کارکرد. قیمت پایین به‌خاطر شاسی/رنگ شکار عالی نیست — "
    "ارزش تعدیل می‌شود نه حذف کامل.\n"
    "5) برای هر دسته (موبایل، لپ‌تاپ، لوازم، خودرو) از پروفایل همان دسته "
    "سؤال بساز و پاسخ را در همان اسلات‌ها بریز. معامله نبند.\n"
    "6) اگر تصویر آگهی داده شد فقط آنچه در تصویر می‌بینی بگو؛ حدس نزن.\n"

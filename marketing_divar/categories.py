...
CATEGORIES: List[Dict[str, str]] = [
    ...
    {"slug": "mobile-tablet", "group": "کالای دیجیتال", "title": "موبایل و تبلت (همه)"},
    {"slug": "mobile-phones", "group": "کالای دیجیتال", "title": "موبایل"},
    {"slug": "tablet", "group": "کالای دیجیتال", "title": "تبلت"},
    {"slug": "mobile-tablet-accessories", "group": "کالای دیجیتال", "title": "لوازم جانبی موبایل"},

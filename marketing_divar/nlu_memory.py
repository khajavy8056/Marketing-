...
def remember_listing(token: str, title: str = "", category: str = "",
                     hunter_level: str = "", price: int = 0, is_defect: bool = False,
                     keyword: str = "", platform: str = "divar", **kwargs) -> None:
    """سازگار با monitor._remember_listing(token, title, category=..., keyword=..., platform=...)."""
    data = _load()
    h = data.setdefault("hunter", {})
    category = category or kwargs.get("category") or ""

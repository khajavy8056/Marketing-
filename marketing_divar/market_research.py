...
PRICE_FACTORS_APPLIANCE = [
    {"key": "used", "label": "کارکرده", "pct": -18, "words": ["کارکرده", "دست دوم"], "question": "نو است یا کارکرده؟", "research": "لوازم خانگی کارکرده معمولاً 15-25٪ زیر نو"},
    {"key": "no_warranty", "label": "بدون گارانتی", "pct": -8, "words": ["بدون گارانتی", "گارانتی تمام"], "question": "گارانتی دارد؟", "research": "بدون گارانتی 6-10٪ افت"},
    {"key": "with_warranty", "label": "گارانتی معتبر", "pct": +4, "words": ["گارانتی", "ضمانت"], "question": "گارانتی تا کی است؟", "research": "گارانتی معتبر 3-5٪ گران‌تر"},
    {"key": "repaired", "label": "تعمیر شده", "pct": -14, "words": ["تعمیر", "تعویض قطعه"], "question": "تعمیر شده؟", "research": "تعمیر موتور/برد 12-18٪ افت"},
    {"key": "with_box", "label": "با کارتن و لوازم", "pct": +3, "words": ["کارتن", "جعبه", "لوازم کامل"], "question": "کارتن و لوازم کامل دارد؟", "research": "با کارتن 2-4٪ گران‌تر"},
    {"key": "motor_weak", "label": "موتور ضعیف / صدای زیاد", "pct": -12, "words": ["صدای زیاد", "موتور ضعیف", "مکش کم"], "question": "مکش و صدا چطور است؟", "research": "مکش ضعیف 10-14٪ افت برای جاروبرقی"},
    {"key": "like_new", "label": "در حد نو", "pct": +2, "words": ["در حد نو", "کم‌کار"], "question": "در حد نو است؟", "research": "کم‌کار +1 تا +3٪"},
]
...
def get_price_factors_for_category(category: str) -> List[Dict[str, Any]]:
    ...
    if any(x in cat for x in ("vacuum", "washer", "refriger", "appliance",
                              "home-kitchen", "heating-cooling", "cookware")):
        return PRICE_FACTORS_APPLIANCE
    return []
...
def research_product(product_keyword: str) -> Dict[str, Any]:
    ...
    # لوازم خانگی — جاروبرقی و مشابه، نه آیفون
    if any(w in product_keyword for w in (
            "جاروبرقی", "جارو برقی", "لباسشویی", "یخچال", "فریزر", "کولر", "اسپلیت")):
        slug = "home-kitchen"
        if "جارو" in product_keyword:
            slug = "vacuum-cleaner"
        elif "لباسشویی" in product_keyword:
            slug = "washers"
        elif "یخچال" in product_keyword or "فریزر" in product_keyword:
            slug = "refrigerator-freezer"
        elif any(w in product_keyword for w in ("کولر", "اسپلیت")):
        ...
        return {
            ...
            "market_note": (
                "لوازم خانگی بازار ایران: نو/کارکرده، گارانتی، کارتن، تعمیر. "
                "جاروبرقی: مکش، صدای موتور، کیسه/مخزن. قیمت از میانه آگهی + ترب."
            ),
            "has_variants": False,
        }
    # خودرو
    if any(w in product_keyword for w in ("پراید", "پژو", "سمند", "دنا", "تیبا", "خودرو", "ماشین")):
        return {
            "product": product_keyword,
            "type": "car",
            "category": "light",
            ...
            "market_note": "خودرو: رنگ، شاسی، کارکرد. قیمت از میانه آگهی‌های همان مدل.",
            "has_variants": False,
        }
    # سایر کالاها — عوامل عمومی، نه آیفون
    return {
        "product": product_keyword,
        "type": "generic",
        "series": [],
